...
#include <string>
            ...
            void updateStock(TreeNode * itemNode, int jumlahOrder)
            {
              if (itemNode != nullptr)
              {
                itemNode->item.stock -= jumlahOrder;
              }
            }
            void enqueue(Queue & q, Order newOrder)
            {
            ...
            int main()
            {
              Queue orderQueue;
              int orderIdCounter = 1;
              insertItem(generateIDItem("Kemeja Flannel", "Kemeja"), "Kemeja Flannel", 25, 100000, "Kemeja");
              insertItem(generateIDItem("Kemeja Denim", "Kemeja"), "Kemeja Denim", 12, 100000, "Kemeja");
              insertItem(generateIDItem("Kemeja Oxford", "Kemeja"), "Kemeja Oxford", 7, 100000, "Kemeja");
              insertItem(generateIDItem("Celana Jeans", "Celana"), "Celana Jeans", 2, 100000, "Celana");
              insertItem(generateIDItem("Celana Kain", "Celana"), "Celana Kain", 6, 100000, "Celana");
              insertItem(generateIDItem("Celana Denim", "Celana"), "Celana Denim", 17, 100000, "Celana");
                          ...
                          case 6:
                          {
                            ...
                            else
                            {
                              while (current != nullptr)
                              {
                                ...
                                if (confirm == "1")
                                {
                                  updateStock(searchItemByName(findCategory(current->order.namaProduk)->itemsTree, current->order.namaProduk), current->order.jumlahOrder);
